...
const PRODUCT_DETAILS: ProductDetails = {
  property_basic: {
    ...
    product_description: 'Covers your home and belongings against damage and theft of common household items.',
    product_details: 'Covers your home and belongings against damage and theft of household items.',
  ...
  property_liability: {
    ...
    product_details: 'Covers any 3rd party liablity claims for damage caused by your porperty. Includes legal fees',
    product_disclaimer: '- maximum total value of all individual items reimbursed is 5000 USD',
  },
  property_ebike: {
    product_name: 'E-bike Insurance Add-on for basic property insurance',
    product_description: 'An add on to the basic property insurance. Covers your ebike.',
    product_details:
...
export function auth(policy_number: number, date_of_birth: string) {
  if ((policy_number === 334455 || policy_number === 888888) && date_of_birth in VALID_DOBS) {
