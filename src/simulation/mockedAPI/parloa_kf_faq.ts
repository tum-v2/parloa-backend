...
const RETRIEVAL_URL: string | undefined =
  process.env.PARLOA_KF_FAQ_RETRIEVAL_URL;
const KB_ID: string | undefined = process.env.PARLOA_KF_KB_ID;
const COMPANY_REFERENCE_NAME: string | undefined =
  process.env.PARLOA_KF_FAQ_COMPANY_REFERENCE_NAME;
...
if (RETRIEVAL_URL === undefined || KB_ID === undefined) {
  ...
  throw new Error(
    "Parloa FAQ API not configured. Set env vars in .env, see .env.example"
  );
}
